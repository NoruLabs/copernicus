    ...
    <>
      ...
      <section className="feature-section apod-section">
        <div className="feature-heading">
          <h2>
            <Link
              href={`/apod?date=${edition.apod?.date ?? edition.editionDate}`}
            >
        ...
        {edition.apod ? (
          <article className="apod-story">
            <div className="plate-frame">
              {edition.apod.mediaType === "image" ? (
                ...
                >
                  ...
                  <img src={edition.apod.url} alt={edition.apod.title} />
                </Link>
            ...
            <div className="story-copy">
              <h3>
                <Link href={`/apod?date=${edition.apod.date}`}>
                  {edition.apod.title}
                </Link>
              </h3>
              <p className="meta">
      ...
      <section className="feature-section">
        <div className="feature-heading">
          <h2>
            <Link href="/near-earth">Near Earth today</Link>
          </h2>
          <p>NASA NEO</p>
        </div>
        ...
        {edition.neo ? (
          <div className="facts-list">
              ...
              <article className="fact-row">
                ...
                <div>
                  ...
                  <p>
                    ...
                    enough to receive extra attention. It does not mean an
                    impact is expected.
                  </p>
                </div>
              </article>
            ...
            <Link
              ...
              href={
                edition.neo.closest
                  ? `/near-earth?object=${encodeURIComponent(edition.neo.closest.id)}`
                  : "/near-earth"
              }
            >
              <article className="fact-row">
      ...
      <section className="feature-section">
        <div className="feature-heading">
          <h2>
            <Link href="/exoplanets">Five recent discoveries</Link>
          </h2>
            ...
            {edition.planets.map((planet) => (
              ...
              >
                <article className="planet-row">
                  ...
                  <p className="figure">
                    {planetMeasure(planet.radiusEarth, planet.distancePc)}
                  </p>
                </article>
              </Link>
            ))}
      ...
      <section className="feature-section">
        <div className="feature-heading">
          <h2>
            <Link href="/image-library">Five latest image briefs</Link>
          </h2>
      ...
      <footer className="colophon">
        Data from NASA APOD, Near Earth Object Web Service, Exoplanet Archive,
        and Image Library.
      </footer>
    </>
  );
