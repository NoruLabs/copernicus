...
- At `48rem` and below, the shell becomes a single column; the rail becomes a fixed bottom navigation with five equal icon+label anchors; feed side borders drop; colophon gains bottom clearance for the bar.
